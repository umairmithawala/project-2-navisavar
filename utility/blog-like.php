...
if (isset($_SESSION['user_id_session'])) {
    ...
    if (isset($_GET['blog_id'])) {
        ...
        $query1 = "SELECT * FROM `like` WHERE `user_id` = '$user_id' AND `blog_id` = '$blog_id'";
...
?>
            ...
            $query2 = "DELETE FROM `dislike` WHERE `user_id` = '$user_id' AND `blog_id` = '$blog_id'";
            $run_query2 = mysqli_query($con, $query2);

            //insert blog_id and user_id into like table
            $query2 = "INSERT INTO `like`(`id`, `user_id`, `blog_id`) VALUES (NULL,'$user_id','$blog_id')";
            $run_query2 = mysqli_query($con, $query2);
            if ($run_query2) {
